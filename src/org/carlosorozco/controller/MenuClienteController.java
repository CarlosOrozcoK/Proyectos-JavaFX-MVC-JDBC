...
import org.carlosorozco.dao.Conexion;
import org.carlosorozco.dto.ClienteDTO;
import org.carlosorozco.model.Cliente;
import org.carlosorozco.system.Main;
import org.carlosorozco.utils.SuperKinalAlert;
...
public class MenuClienteController implements Initializable {
    ...
    @FXML
    TableColumn colClienteId, colNombre, colApellido, colTelefono, colNitt, colDireccion;
    ...
    public void cargarDatos(){
        ...
        if(op == 3){
            ...
            colNitt.setCellValueFactory(new PropertyValueFactory<Cliente, String>("nitt"));
    ...
    public Cliente buscarCliente(){
        ...
        try{
            ...
            if(resultSet.next()){
                ...
                cliente = new Cliente(clienteId, nombre, apellido, telefono, direccion, nitt);
