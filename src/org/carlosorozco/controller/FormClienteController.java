...
public class FormClienteController implements Initializable {
    ...
    TextField tfClienteId, tfNombre, tfApellido, tfTelefono, tfNitt, tfDireccion;
    ...
    public void cargarDatos(Cliente cliente){
        ...
        tfDireccion.setText(cliente.getNitt());

        tfNitt.setText(cliente.getDireccion());
    ...
    public void agregarCliente(){
        ...
        try{
            ...
            statement.setString(5, tfNitt.getText());
            statement.execute();
